...
export default async function GalleryPage(props: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <PageHeader eyebrow="Showcase" title="Gallery" description="A look at our dogs, puppies and champion bloodline." />
      <div className="
                  ...
                  item.kind === 'video'
                    ...
                    : (
                        <div
                          ...
                          "
                        >
                          <MediaImage src={item.url} alt={item.alt || 'Earth Bullies'} rounded={false} />
                        </div>
                      )
                ))}
              </div>
